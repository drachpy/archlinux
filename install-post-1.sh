...
pacman -Sy --noconfirm base-devel systemd-swap sudo vim xorg xorg-xinit git ttf-dejavu adobe-source-code-pro-fonts ufw xfce4-terminal jdk8-openjdk mono python2 curl wget tree htop
